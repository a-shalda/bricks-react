...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["mortar"]["title"] + " " + dictionary["Categories"]["seven"]["title"]
  const categoryDescription = dictionary["Categories"]["mortar"]["title"] + " " + dictionary["Categories"]["seven"]["title"] + dictionary["product_meta"]["details-one"]
...
const ShopPage = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  const type = "Quick-Mix"
  let text = <></>

  return (
    <Shop
      title={dictionary["Categories"]["mortar"]["title"] + " " + dictionary["Categories"]["seven"]["title"]}
