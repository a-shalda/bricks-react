...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["window_sills"]["title"] + " " + dictionary["Categories"]["five"]["title"]
  const categoryDescription = dictionary["Categories"]["window_sills"]["title"] + " " + dictionary["Categories"]["five"]["title"] + dictionary["product_meta"]["details-one"]
...
const ShopPage = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  return (
    <Shop
      title={dictionary["Categories"]["window_sills"]["title"] + " " + dictionary["Categories"]["five"]["title"]}
