...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["bricks"]["title"] + " " + dictionary["Categories"]["one"]["title"]
  const categoryDescription = dictionary["Categories"]["bricks"]["title"] + " " + dictionary["Categories"]["one"]["title"] + dictionary["product_meta"]["details-one"]
...
const ShopPage = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  return (
    <Shop
      title={dictionary["Categories"]["bricks"]["title"] + " " + dictionary["Categories"]["one"]["title"]}
