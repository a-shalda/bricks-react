...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["mortar"]["title"]
  const categoryDescription = dictionary["Categories"]["mortar"]["title"] + dictionary["product_meta"]["details-one"]
...
const ShopPage = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  return (
    <Shop
      title={dictionary["Categories"]["mortar"]["title"]}
