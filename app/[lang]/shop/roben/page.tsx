...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["brick_slips"]["title"] + " " + dictionary["Categories"]["three"]["title"]
  const categoryDescription = dictionary["Categories"]["brick_slips"]["title"] + " " + dictionary["Categories"]["three"]["title"] + dictionary["product_meta"]["details-one"]
...
const ShopPage = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  return (
    <Shop
      title={dictionary["Categories"]["brick_slips"]["title"] + " " + dictionary["Categories"]["three"]["title"]}
