...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["clay_pavers"]["title"]
  const categoryDescription = dictionary["Categories"]["clay_pavers"]["title"] + dictionary["product_meta"]["details-one"]
