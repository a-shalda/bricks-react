...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["stair_floor_tile"]["title"]
  const categoryDescription = dictionary["Categories"]["stair_floor_tile"]["title"] + dictionary["product_meta"]["details-one"]
...
const ShopPage = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  return (
    <Shop
      title={dictionary["Categories"]["stair_floor_tile"]["title"]}
