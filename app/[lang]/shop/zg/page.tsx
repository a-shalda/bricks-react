...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["six"]["title"]
  const categoryDescription = dictionary["Categories"]["six"]["title"] + dictionary["product_meta"]["details-one"]
...
const ShopPage = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  return (
    <Shop
      title={dictionary["Categories"]["six"]["title"]}
