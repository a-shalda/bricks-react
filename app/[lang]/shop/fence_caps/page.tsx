...
export async function generateMetadata(
  ...
  const categoryTitle = dictionary["Categories"]["fence_caps"]["title"]
  const categoryDescription = dictionary["Categories"]["fence_caps"]["title"] + dictionary["product_meta"]["details-one"]
...
const ShopPage = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  return (
    <Shop
      title={dictionary["Categories"]["fence_caps"]["title"]}
